...
class LocationTestClass(TestCase):
    ...
    def test_update_location(self):
        ...
        updated_location = Location.objects.filter(location_name='US')
...
class CategoryTestClass(TestCase):
    def setUp(self):
        self.category = Category(category_name='Animal')
        self.category.save()
    ...
    def test_update_category(self):
        new_category_name = 'People'
        self.category.update_category(self.category.id,new_category_name)
        updated_category = Category.objects.filter(category_name='People')
